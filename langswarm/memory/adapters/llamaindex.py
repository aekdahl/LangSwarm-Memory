...
- **Usage format**:
```
use retriever:name|action|{"query": "Find documents about AI models"}
```
...
- To perform a search:
```
use retriever:llamaindex_retriever|query|{"query": "Explain reinforcement learning"}
```
        """
        )
...
- **Usage format**:
```
use retriever:name|action|{"query_text": "Explain deep learning"}
```
Replace `name`, `action`, and parameters as needed.
...
- To perform a search:
```
use retriever:llamaindex_pinecone|query|{"query_text": "Explain reinforcement learning"}
```
        """
        )
...
- To perform a search:
```
use retriever:llamaindex_weaviate|query|{"query_text": "Explain reinforcement learning"}
```
        """
        )
...
- **Usage format**:
```
use retriever:name|action|{"query_text": "Explain transformers in NLP"}
```
Replace `name`, `action`, and parameters as needed.
...
- To perform a search:
```
use retriever:llamaindex_faiss|query|{"query_text": "Explain reinforcement learning"}
```
        """
        )
...
- **Usage format**:
```
use retriever:name|action|{"query_text": "Find reports on climate change"}
```
Replace `name`, `action`, and parameters as needed.
...
- To perform a search:
```
use retriever:llamaindex_sql|query|{"query_text": "Summarize user conversations"}
```
        """
        )
